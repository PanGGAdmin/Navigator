 ...
 */
public class Vendor_masterfile {
    /*
	...
	IndustrialClass VARCHAR(20),		'行业别'0.
	...
	AmountQuota FLOAT,			'账款额度'
	StartAdvRecv FLOAT,			'期初预收款'
	...
	AccAdvRecv VARCHAR(20),			'预付账款科目'
	AccReceivable VARCHAR(20),		'应付账款科目'
	AccReceivableTemp VARCHAR(20),		'应付暂估科目'
    ...
    private String AccReceivableTemp;
    private String AddField1;
    private String AddField2;
    private String Memo;
    private List<Vendor_masterfile_address> Vendor_masterfile_address;  //供应商主文件表的地址子表

    public List<com.example.pojo.procurement.Vendor_masterfile_address> getVendor_masterfile_address() {
        return Vendor_masterfile_address;
    }

    public void setVendor_masterfile_address(List<com.example.pojo.procurement.Vendor_masterfile_address> vendor_masterfile_address) {
        Vendor_masterfile_address = vendor_masterfile_address;
    }
    ...
    public double getDayOfClose() {
        return DayOfClose;
    }

    public void setDayOfClose(double dayOfClose) {
    ...
    public String getAccReceivableTemp() {
        return AccReceivableTemp;
    }

    public void setAccReceivableTemp(String accReceivableTemp) {
        AccReceivableTemp = accReceivableTemp;
    }
